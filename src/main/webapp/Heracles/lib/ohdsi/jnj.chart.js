(function (root, factory) {
    ...
    module.donut = function () {
        ...
        this.render = function (data, target, w, h, options) {
            ...
            var tooltipBuilder = donut_defaultTooltip(function (d) { return d.data.label; }, function (d) { return intFormat(d.data.value); }, function (d) { return formatpercent(total != 0 ? d.data.value / total : 0.0); });
    ...
    module.trellisline = function () {
        ...
        self.render = function (dataByTrellis, target, w, h, options) {
            ...
            gSeries.append("circle")
                .attr("class", "g-value")
                .attr("transform", function (d) {
                    if (v && v[v.length - 1] && v[v.length - 1].date
                        &&  v[v.length - 1] && (v[v.length - 1].Y_PREVALENCE_1000PP || v[v.length - 1].yPrevalence1000Pp)) {
                        var v = d.values;
