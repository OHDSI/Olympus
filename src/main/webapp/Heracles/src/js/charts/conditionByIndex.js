define(["jquery", "bootstrap", "d3","jnj_chart", "ohdsi_common", "datatables", "datatables-colvis", "colorbrewer", "tabletools"],
    function ($, bootstrap, d3, jnj_chart, common, DataTables, DataTablesColvis, colorbrewer, TableTools) {
        ...
        function ConditionsByIndexRenderer() {}
        ConditionsByIndexRenderer.prototype = {};
        ConditionsByIndexRenderer.prototype.constructor = ConditionsByIndexRenderer;
        ...
        ConditionsByIndexRenderer.render = function(cohort) {
            ...
            function drilldown(id, name, type) {
                ...
                $.ajax({
                    type: "GET",
                    url: ConditionsByIndexRenderer.baseUrl + "/cohortspecific" + type + "/" + id,
        ...
        return ConditionsByIndexRenderer;
    });