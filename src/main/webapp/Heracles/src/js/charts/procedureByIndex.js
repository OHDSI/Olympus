define(["jquery", "bootstrap", "d3","jnj_chart", "ohdsi_common", "datatables", "datatables-colvis", "colorbrewer", "tabletools"],
    function ($, bootstrap, d3, jnj_chart, common, DataTables, DataTablesColvis, colorbrewer, TableTools) {
        ...
        function ProceduresByIndexRenderer() {}
        ProceduresByIndexRenderer.prototype = {};
        ProceduresByIndexRenderer.prototype.constructor = ProceduresByIndexRenderer;
        ...
        ProceduresByIndexRenderer.render = function(cohort) {
            var id = cohort.id;
            ...
            function drilldown(id, name, type) {
                ...
                $.ajax({
                    type: "GET",
                    url: ProceduresByIndexRenderer.baseUrl + "/cohortspecific" + type + "/" + id,
            ...
            $.getJSON(this.baseUrl + '/cohortspecifictreemap', function(data) {
                ...
                if (data.procedureOccurrencePrevalence) {
                    ...
                    if (!procedureOccurrencePrevalence.empty) {
                        table_data = procedureOccurrencePrevalence.conceptPath.map(function (d, i) {
        ...
        return ProceduresByIndexRenderer;
    });